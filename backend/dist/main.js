...
__decorate([
    ...
    (0, permission_guard_1.Permission)({ skipPermissionCheck: true }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
exports.ApiResourcesService = ApiResourcesService = ApiResourcesService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof core_1.DiscoveryService !== "undefined" && core_1.DiscoveryService) === "function" ? _a : Object, typeof (_b = typeof core_1.MetadataScanner !== "undefined" && core_1.MetadataScanner) === "function" ? _b : Object])
], ApiResourcesService);
...
let JwtAuthGuard = class JwtAuthGuard extends (0, passport_1.AuthGuard)('jwt') {
    ...
    canActivate(context) {
        const isPublic = this.reflector.getAllAndOverride(permission_guard_1.PUBLIC_KEY, [
            context.getHandler(),
            context.getClass(),
        ]);
        if (isPublic) {
...
const Permission = (config = {}) => (0, common_1.SetMetadata)(exports.PERMISSION_KEY, config);
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/attendances' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/content-templates' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
/***/ "./src/cramschool/controllers/course-pdfs.controller.ts":
/*!**************************************************************!*\
  !*** ./src/cramschool/controllers/course-pdfs.controller.ts ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CoursePdfsController = void 0;
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
...
const request_types_1 = __webpack_require__(/*! @/types/request.types */ "./src/types/request.types.ts");
const shared_1 = __webpack_require__(/*! @9jang/shared */ "@9jang/shared");
let CoursePdfsController = class CoursePdfsController {
    constructor(coursePdfsService, prisma) {
        this.coursePdfsService = coursePdfsService;
        this.prisma = prisma;
    }
    async uploadPdf(courseId, file, body, req) {
        if (!file) {
            throw new common_1.BadRequestException('請上傳 PDF 檔案');
        }
        if (file.mimetype !== 'application/pdf') {
            throw new common_1.BadRequestException('只接受 PDF 格式檔案');
        }
        if (file.size > 20 * 1024 * 1024) {
            throw new common_1.BadRequestException('PDF 檔案大小不能超過 20MB');
        }
        const user = req.user;
        const userRecord = await this.prisma.accountCustomUser.findUnique({
            where: { id: user.id },
        ...
        if (!createDto.title) {
            throw new common_1.BadRequestException('請提供 PDF 標題');
        }
        try {
    ...
    async viewPdf(_courseId, pdfId, req, res) {
        const user = req.user;
        const userRecord = await this.prisma.accountCustomUser.findUnique({
            where: { id: user.id },
        });
        const { stream, filename } = await this.coursePdfsService.viewPdf(pdfId, user.id, userRecord?.role || 'STUDENT');
        res.set({
    ...
    async downloadPdf(_courseId, pdfId, req, res) {
        const user = req.user;
        const userRecord = await this.prisma.accountCustomUser.findUnique({
            where: { id: user.id },
        });
        const { stream, filename } = await this.coursePdfsService.downloadPdf(pdfId, user.id, userRecord?.role || 'STUDENT');
        res.set({
            'Content-Type': 'application/pdf',
    ...
    async toggleDownload(_courseId, pdfId, body, req) {
        const user = req.user;
        const userRecord = await this.prisma.accountCustomUser.findUnique({
            where: { id: user.id },
        });
        if (body.allow_download === undefined) {
            throw new common_1.BadRequestException('請提供 allow_download 參數');
        }
        return this.coursePdfsService.toggleDownload(pdfId, body.allow_download, user.id, userRecord?.role || 'STUDENT');
    }
    async updatePdf(_courseId, pdfId, updateDto, req) {
        const user = req.user;
        const userRecord = await this.prisma.accountCustomUser.findUnique({
            where: { id: user.id },
        });
    ...
    async deletePdf(_courseId, pdfId, req) {
        const user = req.user;
        const userRecord = await this.prisma.accountCustomUser.findUnique({
            where: { id: user.id },
        });
...
exports.CoursePdfsController = CoursePdfsController;
__decorate([
    (0, common_1.Post)('upload'),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/courses/:courseId/pdfs' }),
    ...
    (0, swagger_1.ApiParam)({ name: 'courseId', description: '課程 ID', example: 1, type: Number }),
    (0, swagger_1.ApiResponse)({
        status: 201,
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: '檔案格式錯誤或缺少必要欄位' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: '無權限上傳' }),
    __param(0, (0, common_1.Param)('courseId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.UploadedFile)()),
    __param(2, (0, common_1.Body)()),
    __param(3, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, typeof (_d = typeof Express !== "undefined" && (_c = Express.Multer) !== void 0 && _c.File) === "function" ? _d : Object, Object, typeof (_e = typeof request_types_1.AuthRequest !== "undefined" && request_types_1.AuthRequest) === "function" ? _e : Object]),
    __metadata("design:returntype", typeof (_f = typeof Promise !== "undefined" && Promise) === "function" ? _f : Object)
], CoursePdfsController.prototype, "uploadPdf", null);
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/courses/:courseId/pdfs' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, typeof (_g = typeof request_types_1.AuthRequest !== "undefined" && request_types_1.AuthRequest) === "function" ? _g : Object]),
    __metadata("design:returntype", typeof (_h = typeof Promise !== "undefined" && Promise) === "function" ? _h : Object)
], CoursePdfsController.prototype, "getPdfs", null);
__decorate([
    (0, common_1.Get)(':pdfId/view'),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/courses/:courseId/pdfs' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({
        summary: '檢視 PDF',
    ...
    (0, swagger_1.ApiParam)({ name: 'courseId', description: '課程 ID', example: 1, type: Number }),
    (0, swagger_1.ApiParam)({ name: 'pdfId', description: 'PDF ID', example: 1, type: Number }),
    (0, swagger_1.ApiResponse)({ status: 200, description: '返回 PDF 檔案流' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: '無權限檢視' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'PDF 不存在' }),
    __param(0, (0, common_1.Param)('courseId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('pdfId', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Request)()),
    __param(3, (0, common_1.Res)({ passthrough: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, typeof (_j = typeof request_types_1.AuthRequest !== "undefined" && request_types_1.AuthRequest) === "function" ? _j : Object, typeof (_k = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _k : Object]),
    __metadata("design:returntype", typeof (_l = typeof Promise !== "undefined" && Promise) === "function" ? _l : Object)
], CoursePdfsController.prototype, "viewPdf", null);
__decorate([
    (0, common_1.Get)(':pdfId/download'),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/courses/:courseId/pdfs' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({
        summary: '下載 PDF',
    ...
    (0, swagger_1.ApiParam)({ name: 'pdfId', description: 'PDF ID', example: 1, type: Number }),
    (0, swagger_1.ApiResponse)({ status: 200, description: '返回 PDF 檔案流' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: '無權限下載或 PDF 不允許下載' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'PDF 不存在' }),
    __param(0, (0, common_1.Param)('courseId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('pdfId', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Request)()),
    __param(3, (0, common_1.Res)({ passthrough: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, typeof (_m = typeof request_types_1.AuthRequest !== "undefined" && request_types_1.AuthRequest) === "function" ? _m : Object, typeof (_o = typeof express_1.Response !== "undefined" && express_1.Response) === "function" ? _o : Object]),
    __metadata("design:returntype", typeof (_p = typeof Promise !== "undefined" && Promise) === "function" ? _p : Object)
], CoursePdfsController.prototype, "downloadPdf", null);
__decorate([
    (0, common_1.Put)(':pdfId/download'),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/courses/:courseId/pdfs' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({
        summary: '切換下載權限',
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: '成功切換下載權限' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: '無權限修改' }),
    __param(0, (0, common_1.Param)('courseId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('pdfId', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Body)()),
    __param(3, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, Object, typeof (_q = typeof request_types_1.AuthRequest !== "undefined" && request_types_1.AuthRequest) === "function" ? _q : Object]),
    __metadata("design:returntype", typeof (_r = typeof Promise !== "undefined" && Promise) === "function" ? _r : Object)
], CoursePdfsController.prototype, "toggleDownload", null);
__decorate([
    (0, common_1.Put)(':pdfId'),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/courses/:courseId/pdfs' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({
        summary: '更新 PDF 資訊',
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: '成功更新 PDF 資訊' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: '無權限修改' }),
    __param(0, (0, common_1.Param)('courseId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('pdfId', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Body)()),
    __param(3, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, typeof (_s = typeof shared_1.UpdateCoursePdfDto !== "undefined" && shared_1.UpdateCoursePdfDto) === "function" ? _s : Object, typeof (_t = typeof request_types_1.AuthRequest !== "undefined" && request_types_1.AuthRequest) === "function" ? _t : Object]),
    __metadata("design:returntype", typeof (_u = typeof Promise !== "undefined" && Promise) === "function" ? _u : Object)
], CoursePdfsController.prototype, "updatePdf", null);
__decorate([
    (0, common_1.Delete)(':pdfId'),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/courses/:courseId/pdfs' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({
        summary: '刪除 PDF',
    ...
    (0, swagger_1.ApiParam)({ name: 'pdfId', description: 'PDF ID', example: 1, type: Number }),
    (0, swagger_1.ApiResponse)({ status: 200, description: '刪除成功' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: '無權限刪除' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'PDF 不存在' }),
    __param(0, (0, common_1.Param)('courseId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('pdfId', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, typeof (_v = typeof request_types_1.AuthRequest !== "undefined" && request_types_1.AuthRequest) === "function" ? _v : Object]),
    __metadata("design:returntype", typeof (_w = typeof Promise !== "undefined" && Promise) === "function" ? _w : Object)
], CoursePdfsController.prototype, "deletePdf", null);
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/courses' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({
        summary: '取得課程列表',
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/enrollment-periods' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/enrollments' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/error-log-images' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/error-logs' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({
        summary: '取得錯題列表',
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/fees' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/group-orders' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/hashtags' }),
    __param(0, (0, common_1.Query)('page', new common_1.ParseIntPipe({ optional: true }))),
    __param(1, (0, common_1.Query)('page_size', new common_1.ParseIntPipe({ optional: true }))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number]),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/leaves' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
let MediaController = class MediaController {
    ...
    async uploadImage(file) {
        ...
        try {
            ...
            throw new common_1.BadRequestException(`保存文件失敗：${errorMessage}`);
        }
    }
...
__decorate([
    ...
    (0, permission_guard_1.Permission)({ resource: '/cramschool' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/order-items' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/orders' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({
        summary: '取得訂單列表',
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/question-tags' }),
    __param(0, (0, common_1.Query)('page', new common_1.ParseIntPipe({ optional: true }))),
    __param(1, (0, common_1.Query)('page_size', new common_1.ParseIntPipe({ optional: true }))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number]),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/questions' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/resources' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({
        summary: '取得資源列表',
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/restaurants' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/sessions' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/student-answers' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/student-groups' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/student-mistake-note-images' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/student-mistake-notes' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/subjects' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
...
__decorate([
    (0, common_1.Get)(),
    (0, permission_guard_1.Permission)({ resource: '/cramschool/teachers' }),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({
        summary: '取得教師列表',
...
const course_pdfs_controller_1 = __webpack_require__(/*! ./controllers/course-pdfs.controller */ "./src/cramschool/controllers/course-pdfs.controller.ts");
const course_pdfs_service_1 = __webpack_require__(/*! ./services/course-pdfs.service */ "./src/cramschool/services/course-pdfs.service.ts");
...
exports.CramschoolModule = CramschoolModule = __decorate([
    (0, common_1.Module)({
        controllers: [
            ...
            course_pdfs_controller_1.CoursePdfsController,
        ],
        providers: [
            ...
            course_pdfs_service_1.CoursePdfsService,
        ],
        exports: [
            students_service_1.StudentsService,
            teachers_service_1.TeachersService,
...
/***/ "./src/cramschool/services/course-pdfs.service.ts":
/*!********************************************************!*\
  !*** ./src/cramschool/services/course-pdfs.service.ts ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CoursePdfsService = void 0;
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const prisma_service_1 = __webpack_require__(/*! ../../prisma/prisma.service */ "./src/prisma/prisma.service.ts");
const path = __webpack_require__(/*! path */ "path");
const fs = __webpack_require__(/*! fs/promises */ "fs/promises");
const fs_1 = __webpack_require__(/*! fs */ "fs");
let CoursePdfsService = class CoursePdfsService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async uploadPdf(file, createDto, userId, userRole) {
        if (userRole !== 'TEACHER' && userRole !== 'ADMIN') {
            throw new common_1.ForbiddenException('只有老師可以上傳 PDF 講義');
        }
        const teacher = await this.prisma.cramschoolTeacher.findFirst({
            where: { userId },
        });
        if (!teacher && userRole !== 'ADMIN') {
            throw new common_1.ForbiddenException('找不到教師資料');
        }
        const course = await this.prisma.cramschoolCourse.findUnique({
            where: { courseId: createDto.course_id },
        });
        if (!course) {
            throw new common_1.NotFoundException(`課程 ID ${createDto.course_id} 不存在`);
        }
        if (userRole === 'TEACHER' && teacher && course.teacherId !== teacher.teacherId) {
            throw new common_1.ForbiddenException('只能在自己的課程下上傳 PDF');
        }
        const mediaRoot = process.env.MEDIA_ROOT || './media';
        ...
        try {
            ...
            if (!createDto.is_visible_to_all && createDto.student_group_ids && createDto.student_group_ids.length > 0) {
                await Promise.all(createDto.student_group_ids.map((groupId) => this.prisma.cramschoolCoursePdfStudentGroup.create({
                    data: {
                        pdfId: pdf.pdfId,
                        groupId,
                    },
    ...
    async getPdfsForStudent(courseId, userId) {
        const student = await this.prisma.cramschoolStudent.findFirst({
            where: { userId },
        });
        if (!student) {
            throw new common_1.NotFoundException('找不到學生資料');
        }
        ...
        if (!enrollment) {
            throw new common_1.ForbiddenException('您未報名此課程');
        }
    ...
    async getPdfsForTeacher(courseId, userId, userRole) {
        if (userRole === 'ADMIN') {
            try {
                const pdfs = await this.prisma.cramschoolCoursePdf.findMany({
                    where: { courseId },
        ...
        if (!course || course.teacherId !== teacher.teacherId) {
            throw new common_1.ForbiddenException('只能查看自己課程的 PDF');
        }
        const pdfs = await this.prisma.cramschoolCoursePdf.findMany({
            where: { courseId },
            include: {
    ...
    async viewPdf(pdfId, userId, userRole) {
        ...
        if (!pdf || !pdf.isActive) {
            throw new common_1.NotFoundException('PDF 不存在或已被刪除');
        }
        ...
        try {
            ...
            throw new common_1.NotFoundException('PDF 檔案不存在');
        }
    }
    async downloadPdf(pdfId, userId, userRole) {
        const pdf = await this.prisma.cramschoolCoursePdf.findUnique({
            where: { pdfId },
            include: {
                course: true,
        ...
        if (!pdf.allowDownload) {
            throw new common_1.ForbiddenException('此 PDF 不允許下載');
        }
        await this.checkViewPermission(pdf, userId, userRole);
        const mediaRoot = process.env.MEDIA_ROOT || './media';
        const fullPath = path.join(mediaRoot, pdf.filePath);
    ...
    async deletePdf(pdfId, userId, userRole) {
        const pdf = await this.prisma.cramschoolCoursePdf.findUnique({
            where: { pdfId },
            include: {
                course: true,
        ...
        if (!pdf) {
            throw new common_1.NotFoundException('PDF 不存在');
        }
        if (userRole === 'ADMIN') {
        }
            ...
            if (!teacher || pdf.course.teacherId !== teacher.teacherId) {
                throw new common_1.ForbiddenException('只能刪除自己課程的 PDF');
            }
        }
        else {
            throw new common_1.ForbiddenException('沒有權限刪除 PDF');
        }
    ...
    async toggleDownload(pdfId, allowDownload, userId, userRole) {
        const pdf = await this.prisma.cramschoolCoursePdf.findUnique({
            where: { pdfId },
            include: {
                course: true,
        ...
        if (userRole === 'ADMIN') {
            ...
            if (!teacher || pdf.course.teacherId !== teacher.teacherId) {
                throw new common_1.ForbiddenException('只能修改自己課程的 PDF 設定');
            }
        }
        else {
            throw new common_1.ForbiddenException('沒有權限修改 PDF 設定');
        }
        await this.prisma.cramschoolCoursePdf.update({
            where: { pdfId },
            data: { allowDownload },
    ...
    async updatePdf(pdfId, updateDto, userId, userRole) {
        const pdf = await this.prisma.cramschoolCoursePdf.findUnique({
            where: { pdfId },
            include: {
                course: true,
        ...
        if (userRole === 'ADMIN') {
            ...
            if (!teacher || pdf.course.teacherId !== teacher.teacherId) {
                throw new common_1.ForbiddenException('只能修改自己課程的 PDF');
            }
        }
        else {
            throw new common_1.ForbiddenException('沒有權限修改 PDF');
        }
        await this.prisma.cramschoolCoursePdf.update({
            where: { pdfId },
            data: {
        ...
        if (updateDto.student_group_ids !== undefined) {
            ...
            if (!updateDto.is_visible_to_all && updateDto.student_group_ids.length > 0) {
                await Promise.all(updateDto.student_group_ids.map((groupId) => this.prisma.cramschoolCoursePdfStudentGroup.create({
                    data: {
                        pdfId,
                        groupId,
                    },
    ...
    async getPdf(id) {
        ...
        if (!pdf) {
            throw new common_1.NotFoundException(`PDF with ID ${id} not found`);
        }
        return this.toPdfDto(pdf);
    }
    async checkViewPermission(pdf, userId, userRole) {
        if (userRole === 'ADMIN') {
            return;
        }
        if (userRole === 'TEACHER') {
        ...
        if (userRole === 'STUDENT') {
            ...
            const groupIds = studentGroups.map((g) => g.groupId);
            const pdfGroupIds = pdf.studentGroups.map((g) => g.groupId);
            const hasPermission = pdfGroupIds.some((gid) => groupIds.includes(gid));
            if (hasPermission) {
                return;
            }
            throw new common_1.ForbiddenException('沒有權限查看此 PDF');
        }
        throw new common_1.ForbiddenException('沒有權限查看此 PDF');
    }
    toPdfDto(pdf) {
        return {
            ...
            student_group_ids: pdf.studentGroups?.map((g) => g.group.groupId) || [],
...
exports.CoursePdfsService = CoursePdfsService;
exports.CoursePdfsService = CoursePdfsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof prisma_service_1.PrismaService !== "undefined" && prisma_service_1.PrismaService) === "function" ? _a : Object])
], CoursePdfsService);
