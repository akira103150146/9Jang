...
import { LaTeXBlock, InlineLatex, ImagePlaceholder, TemplateBlock, Diagram2DBlock, Diagram3DBlock, CircuitBlock, QuestionBlock, PageBreakBlock, SectionBlock } from '../components/BlockEditor/extensions'
 ...
 * 提供統一的編輯器擴展配置
 */
export function useEditorConfiguration(options = {}) {
  const {
    isHandoutMode = false,
    editable = true
  } = options
