 ...
 * 獲取模板列表的函數類型
 */
export type GetTemplatesFunction = () => Template[] | null | undefined

/**
 * 創建模板快速引用擴展
 * @param getTemplates - 獲取模板列表的函數
 * @returns CodeMirror 擴展
 */
export function templateMention(getTemplates: GetTemplatesFunction): Extension {
